...
CREATE TABLE `hemograma` (
  ...
  KEY `fk_id_usersus` (`fk_id_usersus`),
  KEY `fk_data_cons` (`fk_data_cons`),
  CONSTRAINT `hemograma_ibfk_1` FOREIGN KEY (`fk_id_usersus`) REFERENCES `consulta` (`fk_id_usersus`),
  CONSTRAINT `hemograma_ibfk_2` FOREIGN KEY (`fk_data_cons`) REFERENCES `consulta` (`data_cons`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-04 16:10:27
