const btnSalvar = document.querySelector('#btn-atividadefisica-salvar');

function save(){
    let checks = document.querySelectorAll("div > input");
    localStorage.setItem('qtd-fis', checks.length);
...
function insertChecks(){
    let el = document.querySelector('#retorno-atividadefisica');
